...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Sıgn_In = (Button) findViewById(R.id.Sıgn_In);
        Sıgn_Up = (Button) findViewById(R.id.Sıng_Up);


    }

    public void signIn(View view) {
        mAuth.signInWithEmailAndPassword(user_mail.getText().toString(),user_password.getText().toString())
